...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">Q.Trường's Store
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#">Áo đấu sân nhà</a></li>
                        <li><a class="dropdown-item" href="#">Áo đấu sân khách</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item" href="#">Áo thủ môn</a></li>
                    </ul>
                </li>
                <li class="nav-item">
            ...
            <form class="d-flex" role="search">
                ...
                <a href="register.jsp" class="btn btn-primary"
                   style="white-space: nowrap; background-color: white; color: blue; border: 1px solid blue; margin: 0 5px;">
                    Đăng ký
                </a>
...
<div class="container">
    <div class="row">
        <!--            Menu left-->
        <div class="col-lg-3 bg-primary">1
            <div class="list-group">
                <a href="#" class="list-group-item list-group-item-action ">
                    Kit 2024
                </a>
                <a href="#" class="list-group-item list-group-item-action">Kit 2022</a>
                <a href="#" class="list-group-item list-group-item-action">Kit 2021</a>
                <a href="#" class="list-group-item list-group-item-action">Kit 2020</a>
                <a class="list-group-item list-group-item-action disabled" aria-disabled="true">Kit 2019</a>
            </div>
        </div>
        <!--            End menu left-->
        <!--Slider and Products-->
        <div class="col-lg-9 bg-warning">2
            <!--Slider -->
            <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="./image/kit_15.jpg" height="300px" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="./image/kit_19.jpg" height="300px" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="./image/kit_home_24.jpg" height="300px" class="d-block w-100" alt="...">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100">
                        <a href="#">
                            <img src="image/1.png" height="400px" class="card-img-top" alt="ảnh 1">
                        </a>
                        <div class="card-body">
                            <h4 class="card-title">
                            ...
                            <h5>50.000đ</h5>
                            <p class="card-text">Sản phẩm thoáng mát</p>
